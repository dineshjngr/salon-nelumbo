...
export function TeamSection() {
  ...
  return (
    <section id="team" className="bg-white px-[clamp(24px,5vw,96px)] py-24 lg:py-32">
        ...
        <div className="mt-14 flex snap-x gap-4 overflow-x-auto pb-4 md:grid md:grid-cols-2 md:overflow-visible lg:grid-cols-4 lg:gap-6">
          {teamMembers.map((member, index) => (
            <motion.article
              ...
              className="group relative h-[520px] w-[78vw] shrink-0 snap-start overflow-hidden rounded-[30px] border border-[var(--border)] bg-[#F4EDF8] md:w-auto"
            >
              ...
              <div className="absolute inset-x-5 bottom-5 rounded-[24px] border border-white/40 bg-white/16 p-5 text-white backdrop-blur-md transition duration-500 group-hover:-translate-y-3">
                <h3 className="font-serif text-3xl font-semibold">{member.name}</h3>
